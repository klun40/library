package com.sap.hana.cloud.samples.library.persistence.manager;
...
public class EntityManagerFactoryProvider {
	...
	private EntityManagerFactory createEntityManagerFactory(DataSource dataSource) {
		...
		return Persistence.createEntityManagerFactory("com.sap.hana.cloud.samples.library", properties); //$NON-NLS-1$
	}
